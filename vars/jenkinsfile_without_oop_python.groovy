def call(){
    ...
    def createPrAndAddLabelsScript = libraryResource "CreatePrAndAddLabelsWithOutOop.py"
    def requirementsTxt = libraryResource "RequirementsWithOutOop.txt"
    def dockerfile = libraryResource "DockerfileJavaGradle"
